...
func TestInitCommand_CustomPaths_WithFlags(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"--database", customDBPath, "--keyfile", customKeyfilePath, "init", "--force", "--verbose"})
...
keyfile_path: config/from_config.keyfile`
	...
	// Set command line arguments
	rootCmd.SetArgs([]string{"--config", customConfigPath, "init", "--force", "--verbose"})
